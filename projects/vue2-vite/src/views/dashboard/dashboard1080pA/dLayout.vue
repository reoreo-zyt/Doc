		...
		>
			<!-- <panel3D :config="getBorder3DConfig(area.name)" class="panel-3d">
				<div
					...
					v-for="(item, index) in area.portlets"
					:key="index + 'portlet-wrapper'"
				>
					<component
						v-if="item.border"
						:is="item.border"
